"""Image utilities for the Clipsay pipeline.

Helpers for downloading, base64-encoding, and saving images.  Kept
deliberately small — the bulk of the image-rendering logic lives in
:mod:`clients.agnes_image_generator`.
"""
